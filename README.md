...
📈 How to Use
Clone the repository: Load the schema and data: Run the scripts in sql/schema.sql to create tables. Run the scripts in sql/etl.sql to load data into the tables. Run analytical queries: Use the queries in sql/queries.sql or the files in reports/ to generate reports.
